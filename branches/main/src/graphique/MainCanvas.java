...
Canon canon1, canon2;
    ...
    MainCanvas() {
        ...
        setPreferredSize(new Dimension((int) Main.gameValues.CANVAS_SIZE.x, (int) Main.gameValues.CANVAS_SIZE.y));
    }
    /**
     * 
     */
...
@Override
    public void paintComponent(Graphics g) {
        ...
        if (Main.gameValues.isDebugEnabled) { // TODO Temporaire le | true, c'est pour avoir des valeurs en mode normal seulement
                    ...
                    g.drawRect(0, 0, (int) Main.gameValues.CANVAS_SIZE.x - 1, (int) Main.gameValues.CANVAS_SIZE.y - 1);
                } else {
